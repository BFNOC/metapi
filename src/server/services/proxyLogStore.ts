...
function buildProxyLogCoreSelectFields(options?: { includeStreamTimingFields?: boolean }) {
  return {
    ...
    ...(options?.includeStreamTimingFields !== false
      ? {
...
function buildProxyLogSelectFields(options?: {
  ...
  return {
    ...buildProxyLogCoreSelectFields({ includeStreamTimingFields: options?.includeStreamTimingFields }),
...
export function getProxyLogBaseSelectFields() {
  return buildProxyLogCoreSelectFields({ includeStreamTimingFields: false });
}
