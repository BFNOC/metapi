...
const SiteHealth = lazy(() => import('./pages/SiteHealth.js'));
...
export const sidebarGroups = [
  {
    ...
    items: [
      ...
      { to: '/site-health', label: '站点健康', icon: <svg className="sidebar-item-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M4 13h4l2-6 4 10 2-4h4" /></svg> },
