...
**上游已审阅到**：`cdb12a9`（`upstream/main` HEAD，2026-05-10 审阅，含 #518/#510/#505/#533 合入）
...
| 2026-05-10 | [2026-05.md](upstream-sync/2026-05.md) | #518 bug fix + #510 per-site probe + #505 快捷添加 Key + #533 协议兼容性加固 |
